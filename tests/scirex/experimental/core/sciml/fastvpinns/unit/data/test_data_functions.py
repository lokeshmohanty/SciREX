...
from scirex.eperimental.core.sciml.fastvpinns.physics.cd2d import pde_loss_cd2d
from scirex.eperimental.core.sciml.utils.compute_utils import compute_errors_combined
