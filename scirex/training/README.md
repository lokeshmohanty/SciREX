...
trainer.train(train_loader, num_epochs=10, eval_loader=val_loader)
trainer.visualize()
```
...
- `train(train_loader, num_epochs, eval_loader=None, eval_freq=1)`: Executes the training loop and returns the `history` dictionary.
